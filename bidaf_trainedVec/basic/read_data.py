...
def read_data(config, ref, data_filter=None):
    data = config.data
    ...
    data_set = DataSet(data, 'test', shared=shared, valid_idxs=valid_idxs)
    return data_set    

def read_datafile(config, data_type, ref, data_filter=None):
