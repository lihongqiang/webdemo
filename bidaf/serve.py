...
flags.DEFINE_string("model_dir", 'model/01-08-2017/', "input file path")
flags.DEFINE_string("output_dir", 'data/output/', "input file path")
...
class ServeClass():
    ...
    def testData(self, num, data, shared, output_dir, model_dir):
        ...
        m(config, num, data, shared, output_dir, model_dir)
    ...
    def getAnswerPhrase(self, file_path, output_dir, model_dir, num):
        ...
        data = self.generateJson(file_path)
        ...
        self.testData(num, data, shared, output_dir, model_dir)
